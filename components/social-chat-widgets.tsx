...
export function SocialChatWidgets() {
  const [showWidgets] = useState(true)
  return (
    <div
    ...
    >
      ...
      >
        <ThreeDIcon icon={MessengerLogo} size={20} variant="blue" />
      </Button>
      <Button
        ...
        title="Instagram"
      >
        <ThreeDIcon icon={InstagramLogo} size={20} variant="teal" />
      </Button>
    </div>
  )
}
