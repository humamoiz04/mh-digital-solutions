  ...
  return (
    <>
      <div className="text-center mb-12 md:mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#ff6b9d]/20 via-[#e49273]/20 to-[#a8d0d6]/20 border border-[#e49273]/40 mb-6">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 gradient-text drop-shadow-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        {services.map((service, index) => (
          <Link href={service.link} key={index}>
            <Card
              className="glass-card flex flex-col items-center p-6 text-center h-full transition-all duration-500 group relative overflow-hidden hover:scale-110 hover:shadow-3xl cursor-pointer"
              style={{
            ...
            >
              ...
              <div className="absolute top-3 right-3 z-20 px-3 py-1 rounded-full bg-gradient-to-r from-[#ff6b9d]/80 to-[#e49273]/80 text-white text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                {service.badge}
              </div>

              <div className="relative w-full h-40 md:h-48 mb-4 overflow-hidden rounded-lg">
                <Image
              ...
              <CardHeader className="text-center pb-2 relative z-10">
                <CardTitle className="text-xl font-bold text-white group-hover:text-[#ff6b9d] transition-colors duration-300">
                  {service.title}
                </CardTitle>
              </CardHeader>

              <CardContent className="text-center flex-1 relative z-10">
                <CardDescription className="text-slate-400 group-hover:text-slate-300 transition-colors duration-300">
                  {service.description}
                </CardDescription>
              </CardContent>

              <div className="mt-4 text-[#a8d0d6] group-hover:translate-x-2 group-hover:text-[#ff6b9d] transition-all duration-300 relative z-10">
                <ArrowRight size={20} />
              </div>
            </Card>
          </Link>
